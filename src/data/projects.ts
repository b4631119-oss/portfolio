    ...
    localized: {
      en: {
        ...
        customCaseStudy: {
          ...
          overviewTwo: "The key feature is separate flows for teachers and students: teachers can create courses and exams, review results and group progress, while students can learn, take tests and see their results. Access logic is built on Row Level Security (RLS) in PostgreSQL through Supabase.",
          roleTitle: "Role",
